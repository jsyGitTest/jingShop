...
<head>
    ...
    <title>JingShop - blog fullwidth</title>
        ...
        <div class="container">
            <div>
                <figcaption class="blog_content">
                    <h4 class="post_title"><a href="blog-details.ftl">听会歌在买菜</a></h4>
                    <div class="articles_date">
                        <p>07/02/2023 | <a href="#">春不晚</a> </p>
                    </div>
                    <div class="blog_aduio_icone">
                        <audio controls>
                            <source src="http://www.ytmp3.cn/down/78488.mp3" type="audio/mp3">
                        </audio>
                    </div>
                    <p class="post_desc">你一句春不晚 我到了真江南</p>
                </figcaption>
            </div>
            <div class="row">
                            ...
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="/blog/detail?id=${b.id}"><img src="${b.url}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
